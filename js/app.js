    ...
    function renderProjekt(container, ueberProjektId, projektId) {
      ...
      const tabDefs = [
        { id: 'plan', label: 'Plan & Zeitplan', icon: '\u2713' },
        { id: 'kosten', label: 'Kostenübersicht', icon: '\u20AC' },
        { id: 'personal', label: 'Personalplan', icon: '\u263A' },
        { id: 'foerder', label: 'Förderplan', icon: '\u2691' },
        { id: 'extern', label: 'Externe Entwicklung', icon: '\uD83D\uDD17' },
      ];
      ...
      for (const tab of tabDefs) {
        const tabBtn = el('button', {
          ...
          tab.id === 'plan'
            ? el('span', { className: 'plan-tab-check' }, tab.icon)
            : el('span', { className: 'plan-tab-icon' }, tab.icon),
          tab.label
        );
